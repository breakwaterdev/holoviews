...
# FIXME: moved inline below with a hard coded version number, so we can
# install from git with poetry, which does AST parsing & expects it that way.
# I have no words.
...
if __name__ == "__main__":
    ...
    if 'install' in sys.argv:
        ...
        extras = '\n'.join('holoviews[%s]' % e for e in extras_require)
